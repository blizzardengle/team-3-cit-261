...
signUpList.prototype.print = function(){
	...
	while(current!=null){
		...
		html += "<div class='age'>"+current.age+"</div>"; html += '<div class="buttons"><input type="button" Value="Profile" onclick="getProfile('+counter+')"></div>';
        ...
        html += "<div id='profile' style='padding:10px'></div>";
	return html;
}
...
function getProfile(id) {
  ...
  xmlhttp.onreadystatechange=function() {
    ...
    if (xmlhttp.readyState===4 && xmlhttp.status===200) {
      	var profile = xmlhttp.responseText;
