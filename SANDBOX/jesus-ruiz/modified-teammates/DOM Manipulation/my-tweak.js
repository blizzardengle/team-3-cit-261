...
signUpList.prototype.print = function(){
	...
	while(current!=null){
		...
		html += '<div class="buttons"><input type="button" value="Edit" onclick="editList(\''+current.id+'\')"></div>';
		html += "</div>";
		current = current.nextRecord;
	}
	return html;
...
// This function allows us to edit elements in our list and save changes to local storage
...
// This function saves the information in the list
